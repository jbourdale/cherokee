...
c_http_decision_diagram d_static_file_is_get = { is_get_or_head_method, &d_serve_static_file, &d_method_not_implemented };
c_http_decision_diagram d_static_file = { is_static_file, &d_static_file_is_get, &d_not_found };

c_http_decision_diagram d_static_dir_is_get = { is_get_or_head_method, &d_serve_static_dir, &d_method_not_implemented };
c_http_decision_diagram d_static_dir = { is_static_directory, &d_static_dir_is_get, &d_static_file };
